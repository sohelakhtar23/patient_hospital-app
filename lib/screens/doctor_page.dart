...
import 'package:hospital_ui/screens/doctor_profile_page.dart';

import 'package:hospital_ui/widgets/avatar_image.dart';
import 'package:hospital_ui/widgets/doctor_box.dart';
              ...
              children: [
                Row(
                  children: [
                    ...
                    SizedBox(width: 5,),
                    Icon(Icons.filter_list_rounded, color: kPrimary, size: 35,),
                  ],
                ),
                SizedBox(height: 20,),
                // SingleChildScrollView(
